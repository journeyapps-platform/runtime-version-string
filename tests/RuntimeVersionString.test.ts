...
describe('RuntimeVersionString', () => {
  it('parses as expected', () => {
    const first = '1.1.1-beta+1';
    const second = '1.1.1-dev.something-else-here+12';
    const third = '1.1.1-stable+3333';
    const fourth = '1.1.1-rc';
    const fifth = '1.1.1-rc+1';
